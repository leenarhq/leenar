  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-10">
      <div className="pointer-events-auto flex w-full max-w-[440px] flex-col gap-3 px-4">
        <p className="mb-1 text-center text-[15px] font-semibold tracking-tight text-[var(--muted-foreground)]">
        ...
        <button
          ...
          className="flex flex-col gap-1 rounded-xl border border-[var(--border)] bg-[var(--app-surface)] p-4 text-left transition-colors hover:border-[var(--dim)]"
        >
