# Leenar Contributor License Agreement

Thank you for contributing to Leenar Core.

This agreement clarifies the intellectual property licence granted with
contributions from any person or entity. It is adapted from the Apache Software
Foundation's Individual Contributor License Agreement.

By submitting a pull request to this repository and signing this agreement, You
...
authorised by the copyright owner that is entering into this agreement.
"Contribution" means any original work of authorship, including any
modifications or additions to an existing work, that is intentionally submitted
by You to Leenar for inclusion in, or documentation of, any of the products
owned or managed by Leenar.

**2. Grant of Copyright Licence.** You hereby grant to Leenar and to recipients
of software distributed by Leenar a perpetual, worldwide, non-exclusive,
no-charge, royalty-free, irrevocable copyright licence to reproduce, prepare
derivative works of, publicly display, publicly perform, sublicense, and
distribute Your Contributions and such derivative works, **under any licence
terms, including proprietary terms**. You understand that Leenar Core is
distributed under AGPL-3.0-only and that Leenar also distributes proprietary
products which may incorporate Your Contribution.

**3. Grant of Patent Licence.** You hereby grant to Leenar and to recipients of
software distributed by Leenar a perpetual, worldwide, non-exclusive,
no-charge, royalty-free, irrevocable patent licence to make, have made, use,
offer to sell, sell, import, and otherwise transfer the Work, where such licence
